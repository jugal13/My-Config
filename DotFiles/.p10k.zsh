# Generated by Powerlevel10k configuration wizard on 2020-06-18 at 19:43 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_FOREGROUND=46
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=235
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_FOREGROUND=214
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_BACKGROUND=235
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_FOREGROUND=196
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_BACKGROUND=235
  ...
  typeset -g POWERLEVEL9K_SWAP_BACKGROUND=215
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=172
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=216
  ...
  typeset -g POWERLEVEL9K_BATTERY_BACKGROUND=234
  ...
  function prompt_date() {
    p10k segment -b 31 -f 234 -t '%D{%d/%m/%Y}' -i $'\uF073'
  }
